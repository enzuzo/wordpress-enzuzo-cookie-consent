...
class Enzuzo_Cookie_Consent_Admin {
    ...
    public function settings_menu_init() {
        ...
        add_settings_field(
            ...
            '<span class="enzuzo-cookie-consent-tooltip" title="' . __( 'Set your UUID from Enzuzo Dashboard', 'enzuzo-cookie-consent' ) . '">?</span>' . __( 'account UUID (required):', 'enzuzo-cookie-consent' ),
