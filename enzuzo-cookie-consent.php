 ...
 *
 * @wordpress-plugin
 * Plugin Name:       Enzuzo Cookie Consent | GTM compatible consent management
...
function enzuzo_cookie_consent_settings_links( $links ) {
    $url = menu_page_url('enzuzo_cookie_consent', false);
...
function enzuzo_cookie_consent_has_uuid() {
